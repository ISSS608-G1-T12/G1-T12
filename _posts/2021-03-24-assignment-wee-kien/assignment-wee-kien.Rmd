...
```{r, echo=TRUE, eval=TRUE, fig.cap="Normal graphs without indicators"}
...
```{r, echo=TRUE, eval=TRUE, fig.cap="Candlestick graphs with simple moving average indicators"}
# 20-day SMA
...
```{r, echo=TRUE, eval=TRUE, fig.cap="Candlestick graphs with bollinger bands indicators"}
