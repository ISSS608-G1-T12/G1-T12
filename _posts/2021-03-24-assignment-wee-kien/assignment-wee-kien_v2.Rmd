...
```{r, fig.align="center",echo=FALSE, out.width="100%", fig.cap="Example of using Anomaly Detection to recognize potential turning points in a securities' time series behaviour "}
...
```{r, fig.align="center",echo=FALSE, out.width="100%", fig.cap="6 month rolling correlation between chosen stocks and underlying benchmark index"}
...
```{r, fig.align="center",echo=FALSE, out.width="100%", fig.cap="Analysing the Equity Curves/ Performance of multiple portfolios"}
knitr::include_graphics("insight3_port_analysis.png")
```

Explanation of functionality 4
