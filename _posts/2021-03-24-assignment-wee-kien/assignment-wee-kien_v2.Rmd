...
```{r, layout = 'l-body-outset',echo=TRUE, eval=TRUE, out.width="100%", fig.cap="Candlestick graphs with simple moving average indicators"}
# 20-day SMA
sma_fast <- SMA(ticker_data_daily_xts$close, n=20)
# 40-day SMA
sma_med <- SMA(ticker_data_daily_xts$close, n=40)
# 200-day SMA
sma_slow <- SMA(ticker_data_daily_xts$close, n=50)
...
```{r, layout = 'l-page',echo=TRUE, eval=TRUE, out.width="100%", fig.cap="Candlestick graphs with bollinger bands indicators"}
...
```{r, echo=FALSE, eval=TRUE, out.width="100%", fig.cap="Installing required packages for CandleStickPattern package"}
# Testing CandleStickPattern package from Ko Chiu Yu
...
head(portfolio_growth_monthly_multi)
```
...
### 3.1 Sketch of Proposed Visualization

TO INSERT SKETCH HERE, can be multiple pictures.
Can take from powerpoint slide.


### 3.2 Suggested Interactivity in the Proposed Visualization
...
Explanation of functionality 1


**Insight 2**

Explanation of functionality 2


**Insight 3**

Explanation of functionality 3
