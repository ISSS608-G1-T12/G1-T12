...
### 1.2 Objective/ Motivation and literature review
...
```{r, echo=FALSE, eval=TRUE, out.width="100%", fig.cap="Visualization the monthly returns of Portfolio 2"}
...
```{r, echo=FALSE, eval=TRUE, out.width="100%", fig.cap="Visualization the monthly returns of Portfolio 3"}
